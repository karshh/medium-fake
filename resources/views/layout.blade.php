                ...
                <header class="blog-header py-3">
                    <div class="row flex-nowrap justify-content-between align-items-center">
                        <div class="nav">
                            ...
                            <a style="margin-top:7px"class="nav-options right-options" id="signIn" href="#">Sign in</a>
                            <a class="btn nav-options right-options" href="#">Get started</a>
                      </div>
                    </div>
